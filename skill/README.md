...
| `web-deobfuscation` | `web-deobfuscation/` | Web JS evidence-gated 反混淆（safe AST / JSVMP opcode+Trace / JS-WASM boundary / parity / triage） |
...
| `emil-design-eng` | `emil-design-eng/` | 前端设计工程编排器（6 子技能路由、动画审查与强制审查门） |

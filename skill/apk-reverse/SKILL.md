...
|------|------|-------------------|------|
| 分类 | L0 | 步骤 1 Triage | manifest 摘要、package、so 列表 |
| 侦察 | L1 | 步骤 1-2 | Java 源码浏览、关键类/方法列表 |
| 决策 | — | 步骤 3 判断主战场 | 确定为 Java/smali/native 主线 |
| 深挖 | L2-L3 | 步骤 4-5 | smali patch、Frida Hook、native 分流 |
| 产出 | — | 步骤 6 Native 分流 | 报告 + Hook 脚本 |
